...
import gob.firmadordigital.pfdr.DatosFirmaRemota;
...
import gob.firmadordigital.pfdr.DatosLoginPFDR;
import gob.firmadordigital.pfdr.DocumentoAFirmarPFDR;
import gob.firmadordigital.pfdr.IdentidadRemota;
import gob.firmadordigital.pfdr.JSON_DocumentoFirmadoPFDR;
import gob.firmadordigital.pfdr.Otp;
                                ...
                                for (int intentos=0;intentos<3;++intentos){
                                    ...
                                    try (Response resp = builder.post(Entity.entity(otp_json,"application/json"))) {
                                        if (resp.getStatus()== 201 || resp.getStatus()==200){
                                            ...
                                            if (intentos==2){throw new OtpBaneadoException(PDFirma.resourceBundle.getString("ERROR_079"));}
